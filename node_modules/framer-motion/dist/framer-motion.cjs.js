...
function calcDelta(prev, next) {
    var delta = tslib_1.__assign({}, calcAxisDelta(prev, next, axisLabels.x), calcAxisDelta(prev, next, axisLabels.y));
    return delta;
}
var offset = {
...
function useLayoutAnimation(ref, values, controls, layoutTransition, positionOnly) {
    ...
    layoutSync.render(function () {
        ...
        styler__default(element).set({ originX: delta.originX, originY: delta.originY });
